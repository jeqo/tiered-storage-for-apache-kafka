...
class AzureBlobStorageSocks5Test {
    ...
    @Test
    void worksWithAuthenticatedProxy() throws StorageBackendException {
        ...
        storage.upload(new ByteArrayInputStream(new byte[] {0, 1, 2, 3}), OBJECT_KEY);
        storage.fetch(OBJECT_KEY);
    }

    @Test
    void worksWithUnauthenticatedProxy() throws StorageBackendException {
